...
namespace StoreFront.UI.MVC.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.DirectReportID = new SelectList(db.Employees, "EmployeeID", "EmployeeFName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,EmployeeFName,EmployeeLName,DateOfHire,ExitDate,DepartmentID,DirectReportID")] Employee employee)
        {
            ...
            ViewBag.DirectReportID = new SelectList(db.Employees, "EmployeeID", "EmployeeFName", employee.DirectReportID);
            return View(employee);
        }
